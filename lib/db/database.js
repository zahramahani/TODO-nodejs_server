...
exports.getUserDb = (boardId) => {
  ...
  return client
    ...
    .then(() => {
      let query
      if (boardId) {
        let a='SELECT "userName" FROM "users" , "boards" , "boards-users" WHERE "boards-users" ."boardId" = "boards"."boardId" and "boards-users"."userId" = "users"."userId" and "boards"."boardId"=($1)'[boardId];
        query = client.query('SELECT "userName" FROM "users" , "boards" , "boards-users" WHERE "boards-users" ."boardId" = "boards"."boardId" and "boards-users"."userId" = "users"."userId" and "boards"."boardId"=($1)'[boardId])
      }
      return query
    })
    .then((res) => {
...
exports.postOwnerDb = (body) => {
  ...
  return client
    .connect()
    .then(() => {
      return client.query(`INSERT INTO "boards-users"("boardId","userId")
                      VALUES ($1, $2);`,
      // eslint-disable-next-line indent
