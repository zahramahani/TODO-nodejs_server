...
exports.removeBoard = (id) => {
  ...
  return client
    .connect()
    .then(() => {
      client.query(`DELETE  FROM "todos" WHERE "todos"."boardId"=($1)`, [id])
...
exports.removeTodo = (id) => {
  ...
  return client
    .connect()
    .then(() => {
      client.query(`DELETE  FROM "tasks" WHERE "tasks"."todoId"=($1)`, [id])
      return client.query('DELETE FROM "todos" WHERE "todos"."todoId"=($1)', [id])
    })
    .then((res) => {
      result = res
      return client.end()
