  ...
  return client
    ...
    .then(() => {
      ...
      if (id) {
        ...
        query = client.query('SELECT * FROM "tasks" ORDER BY "boardId" ASC')  //changed
      }
      return query
    })
    .then((res) => {
...
exports.postOwnerDb = (body) => {
  ...
  return client
    .connect()
    .then(() => {
      return client.query(`INSERT INTO "boards-users" ("boardId","userId") VALUES ($1, $2) WHERE` + body.userId + `NOTIN (SELECT "userId" FROM "boards-users")`,
