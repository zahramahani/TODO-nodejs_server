...
exports.deleteUserFromBoard = (request, response, params) => {
  ...
  // const valid = ajv.validate(schema.userIdSchema, temp.userId)
  // const validatonError = ajv.errors
...
exports.signUp = (request, response, params) => {
  // const passSignupError = {
  //   type: 'passSignupError',
  //   explain: 'password is used befor enter new username'
  // }
  // const userSignupError = {
  //   type: 'userSignupError',
  //   explain: 'username is used befor enter new username'
  // }
  getRawBody(request)
    .then((bodyBuffer) => {
      const body = JSON.parse(bodyBuffer.toString())
      ...
      if (valid) {
        ...
        // if (!passwordChecked) {
        //   error(response, passSignupError)
        // }
        if (passwordChecked) {
